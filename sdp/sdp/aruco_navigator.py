...
class ImageProcessor(Node):
    def __init__(self):
        ...
        self.camera_subscriber = self.create_subscription(Image, 'camera_0_feed/image_raw', self.image_processing_callback, 1)
        self.bridge = CvBridge()
        self.processed_image_publisher = self.create_publisher(Image, 'camera_0_feed/processed_image', 1)
